...
const INITIAL_EVENTS_SUMMARY: EventsSummaryEntity = {
  ...
  const superMinter_MintedEntity: SuperMinter_MintedEntity = {
    id: event.transactionHash + event.logIndex.toString(),
      ...
      to: event.params.to      ,
      data_0: event.params.data
          [0]
      ,
      data_1: event.params.data
          [1]
      ,
      data_2: event.params.data
          [2]
      ,
      data_3: event.params.data
          [3]
      ,
      data_4: event.params.data
          [4]
      ,
      data_5: event.params.data
          [5]
      ,
      data_6: event.params.data
          [6]
      ,
      data_7: event.params.data
          [7]
      ,
      data_8: event.params.data
          [8]
      ,
      data_9: event.params.data
          [9]
      ,
      data_10: event.params.data
          [10]
      ,
      data_11: event.params.data
          [11]
      ,
      data_12: event.params.data
          [12]
      ,
